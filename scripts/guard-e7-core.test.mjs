...
import { checkCatalogHygiene, checkE7Core, checkLoadoutHygiene, FLOORS } from "./guard-e7-core.mjs";
...
test("live exclusive equipment keys match catalog ids", () => {
  assert.deepEqual(checkLoadoutHygiene(ROOT), []);
});
