...
import { E as rankProgress, n as ARCHETYPE_META, v as divisionForVp, w as nextDivision } from "./recipes-DsR1fcfA.mjs";
import { a as cn, i as Input, r as Button } from "./boot-screen-CBR_ZPNs.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { o as getHero, r as useArenaStore, s as useCatalog } from "./router-DrPSiwCO.mjs";
...
import { a as groupByArchetype, n as copyFightDump, o as groupByRecipe, r as downloadFightDump, s as winRate, t as buildFightDump } from "./export-stats-D8bURXXW.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/log-QSyMQYSK.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Older fights stay here. Scout no longer records Won or Lost."
					})
				]
			}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: nxt ? `${nxt.minVp - vp} to ${nxt.label}${nxt.placement ? ` · ${nxt.placement}` : ""}` : rank.placement ?? "Top of the board"
						}),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Past fights only. Scout no longer records new ones."
						})
					]
				}) })]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								variant: "ghost",
								onClick: () => {
									copyFightDump(dump()).then(() => toast("Copied. Paste it here.")).catch(() => toast.error("Could not copy"));
								},
								children: "Copy"
							}),
					...
					children: "No new fights from Scout. Export still works from Admin → Stats."
				}) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
